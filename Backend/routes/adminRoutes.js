...
router.put('/access/update',authMiddleware.authenticateToken,authMiddleware.authorizeRoles("manageAdmins"),validationMiddleware.validateBody(validator.roleAccessSchema),adminController.updateAdminAccess)
